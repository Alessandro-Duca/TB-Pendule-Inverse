...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|l|l|l|}
            \hline
            \# & Fonctions système                                                                & Besoin    \\ \hline
            ...
            F9 & Doit respecter les normes EN ISO 12100 de la SUVA sur la sécurité des machines   & N5.3      \\ \hline
        \end{tabular}%
    }
\end{table}
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|l|l|l|l|}
            \hline
            \#                                                                                                                      & Exigence                                                                & Valeur attendue  & Fonction \\ \hline
...
\begin{figure}[H]
    \centering
    \includegraphics[width = \textwidth]{assets/figures/PenduleInstructables.jpg}
