...
\iffalse
    ...
    %Mises en plans des pièces mécaniques
    \includepdf[pages=-]{Annexes/Couplage Encodeur}
    \includepdf[pages=-]{Annexes/Couplage Tige}
    \includepdf[pages=-]{Annexes/Liaison chariot}
    \includepdf[pages=-]{Annexes/Liaison Moteur}
    \includepdf[pages=-]{Annexes/Support Amortisseur}
    \includepdf[pages=-]{Annexes/Support Amortisseur 2}
    \includepdf[pages=-]{Annexes/Support Guidage Cable}
    \includepdf[pages=-]{Annexes/Support Pieds}
    \includepdf[pages=-]{Annexes/Support Tete Lecture}
