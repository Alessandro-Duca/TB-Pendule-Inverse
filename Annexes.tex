...
\iffalse
  ...
  %Planning
  \includepdf[pages=-,landscape=true]{Annexes/2022-03-28 Planning.pdf}
  ...
  %Mises en plans des pièces mécaniques
  \includepdf[pages=-,landscape=true]{Annexes/MEP Couplage Encodeur}
  \includepdf[pages=-,landscape=true]{Annexes/MEP Couplage Tige}
  \includepdf[pages=-,landscape=true]{Annexes/MEP Liaison chariot}
  \includepdf[pages=-,landscape=true]{Annexes/MEP Liaison Moteur}
  \includepdf[pages=-,landscape=true]{Annexes/MEP Support Amortisseur}
  \includepdf[pages=-,landscape=true]{Annexes/MEP Support Amortisseur 2}
  \includepdf[pages=-,landscape=true]{Annexes/MEP Support Guidage Cable}
  \includepdf[pages=-,landscape=true]{Annexes/MEP Support Pieds}
  \includepdf[pages=-,landscape=true]{Annexes/MEP Support Tete Lecture}
